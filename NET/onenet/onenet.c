...
extern u8 lastmove;//窗户标志位
extern u8 HomeMode;//自动模式标志位 0：手动模式 1：自动模式 2:离家模式 3：电影模式
...
//				}
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				{
					json_value = cJSON_GetObjectItem(json , "target");//提取对应属性的数值
